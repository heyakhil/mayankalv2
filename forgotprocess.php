<?php   
      ...
      if(mysqli_num_rows($run) > 0){
           $sql1="UPDATE `user` SET `forgot_verification`='$randomnum' WHERE `email`='$email'";
        ...
        $message .="<h1 style='width: 300px;'><i>Mayankal</i></h1>
            <h3><i>We are here to help blogger community in the way of providing leads for vrbkmrkmbrlmbl;rmvlrmvlmbvmlmvfb<br>vfn fnv lfnlfvm fm lf vf guest post.</i></h3>
