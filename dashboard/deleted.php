				...
				<a href="#" class="task-listing">
					...
					<div class="task-listing-details">
						...
						<div class="task-listing-description">
							...
							<h3 class="task-listing-title" style="margin-top: 10px;">Order Id: 1</h3>
							
							<h3 class="task-listing-title" style="margin-top: 10px;"><i class="icon-line-awesome-calendar" aria-hidden="true"></i>: 16-11-2019</h3>
