					...
					<ul id="responsive">
						...
						<li><a href="#">Pages</a>
							<ul class="dropdown-nav">
								...
								<li><a href="pages-checkout-page.html"
				...
				<!-- <a href="#" class="task-listing"> -->
					...
					<div class="task-listing-details">
						...
						<div class="task-listing-description">
							...
							<div class="col-md-3 " style="margin-left: 0px;"><a href="#small-dialog-2" onclick="myclick(this.id);" id="1" class="popup-with-zoom-anim button ripple-effect><i class="fa fa-edit">Read Your Post</i></a>
				...
				<!-- <a href="#" class="task-listing"> -->
					...
					<div class="task-listing-details">
						...
						<div class="task-listing-description">
							...
							<div class="col-md-3 " style="margin-left: 0px;"><a href="#small-dialog-2"onclick="myclick(this.id);" id="2" class="popup-with-zoom-anim button ripple-effect"><i class="fa fa-edit">Read Your Post</i></a>
				...
				<!-- <a href="#" class="task-listing"> -->
					...
					<div class="task-listing-details">
						...
						<div class="task-listing-description">
							...
							<div class="col-md-3 " style="margin-left: 0px;"><a href="#small-dialog-2" onclick="myclick(this.id);" id="3" class="popup-with-zoom-anim button ripple-effect"><i class="fa fa-edit">Read Your Post</i></a>
							...
							<h3 class="task-listing-title">Order Id: 3</h3>
				...
				<!-- <a href="#" class="task-listing"> -->
					...
					<div class="task-listing-details">
						...
						<div class="task-listing-description">
							...
							<div class="col-md-3 " style="margin-left: 0px;"><a href="#small-dialog-2" onclick="myclick(this.id);" id="4" class="popup-with-zoom-anim button ripple-effect"><i class="fa fa-edit">Read Your Post</i></a>
							...
							<h3 class="task-listing-title">Order Id: 4</h3>
...
<script src="../js/Copyme/copyme.js"></script>
<script>
