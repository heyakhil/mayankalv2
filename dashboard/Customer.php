			...
			<div class="freelancers-container freelancers-grid-layout margin-top-35">
					...
					<div class="freelancer-details">
						<div class="freelancer-details-list">
							<ul>
								...
								<li>Websites <strong>$60 / hr</strong></li>
				...
				<div class="freelancer">
					...
					<div class="freelancer-details">
						<div class="freelancer-details-list">
							<ul>
								<li>Country <strong><i class="icon-material-outline-location-on"></i> Berlin</strong></li>
								<li>Websites <strong>$40 / hr</strong></li>
				...
				<div class="freelancer">
					...
					<div class="freelancer-details">
						<div class="freelancer-details-list">
							<ul>
								<li>Country <strong><i class="icon-material-outline-location-on"></i> Warsaw</strong></li>
								<li>Websites <strong>$50 / hr</strong></li>
				...
				<div class="freelancer">
					...
					<div class="freelancer-details">
						<div class="freelancer-details-list">
							<ul>
								<li>Country <strong><i class="icon-material-outline-location-on"></i> Brisbane</strong></li>
								<li>Websites <strong>$70 / hr</strong></li>
				...
				<div class="freelancer">
					...
					<div class="freelancer-details">
						<div class="freelancer-details-list">
							<ul>
								<li>Country <strong><i class="icon-material-outline-location-on"></i> Milan</strong></li>
								<li>Websites <strong>$80 / hr</strong></li>
				...
				<div class="freelancer">
					...
					<div class="freelancer-details">
						<div class="freelancer-details-list">
							<ul>
								<li>Country <strong><i class="icon-material-outline-location-on"></i> Paris</strong></li>
								<li>Websites <strong>$50 / hr</strong></li>
